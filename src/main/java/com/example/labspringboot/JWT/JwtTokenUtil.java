package com.example.labspringboot.JWT;
...
public class JwtTokenUtil implements Serializable {
    ...
    private String secret="noobmaster69";
    ...
    public String generateToken(User userDetails) {
        ...
        claims.put("Firstsurname",userDetails.getFirst_surname());
        claims.put("SecondSurname",userDetails.getSecond_surname());
        claims.put("Phone",userDetails.getPhone());
        claims.put("SecondPhone",userDetails.getSecondphone());
